...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/add_customer?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/add_item?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/business_summary?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/check_stock?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/customer_account?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/dues?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/item_details?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
  -d '{"item": "{{item}}", "sku_id": "{{sku_id}}"}'
```
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/list_customers?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
  -d '{}'
```
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/list_inventory?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
  -d '{}'
```
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/low_stock?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
  -d '{"limit": "{{limit}}"}'
```
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/price_quote?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/recent_activity?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
  -d '{"limit": "{{limit}}"}'
```
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/record_payment?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/record_purchase?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/record_sale?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/remove_item?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
  -d '{"item": "{{item}}", "sku_id": "{{sku_id}}"}'
```
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/search_items?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
  -d '{"query": "{{query}}"}'
```
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/send_bill?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/send_reminders?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
  -d '{"days_before": "{{days_before}}"}'
```
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/send_summary?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
  -d '{"period": "{{period}}"}'
```
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/shop_profile?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
  -d '{}'
```
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/show_bill?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/show_summary?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
  -d '{"period": "{{period}}", "days": "{{days}}", "start": "{{start}}", "end": "{{end}}"}'
```
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/stock_take?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/stock_value?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
  -d '{}'
```
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/top_items?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/update_item?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
...
```bash
curl -X POST 'https://munimai.vercel.app/api/agent/tool/update_shop_profile?caller={{caller_number}}&shop_key={{shop_key}}&secret={{agent_secret}}' \
  -H 'Content-Type: application/json' \
  -H 'X-Agent-Secret: {{SECRET_KEY}}' \
