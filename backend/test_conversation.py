...
# imports below.
import os
os.environ.setdefault("MUNIM_TODAY", "2026-07-26")
...
class ConversationStateTests(unittest.TestCase):
    ...
    def test_mixed_order_announces_and_remembers_unavailable_item(self):
        ...
        with patch.object(conversation.sarvam_client, "has_key",
            ...
            self.assertIn("wire", out["say"])
            # wire isn't stocked — Munim offers to add it rather than
...
class NewItemConfirmationTests(unittest.TestCase):
    ...
    def test_declining_just_acknowledges_and_resets(self):
        """Saying no is an answer, not an error. Munim accepts it, writes
...
class ClockTests(unittest.TestCase):
    ...
    def tearDown(self):
        os.environ["MUNIM_TODAY"] = "2026-07-26"
    ...
    def test_pin_is_read_on_every_call_not_cached_at_import(self):
        ...
        os.environ["MUNIM_TODAY"] = "2026-07-27"
