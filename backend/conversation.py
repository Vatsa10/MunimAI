"""
conversation.py — voice dialogue for "Hey Munim".
...
confirmed, so nothing commits half-filled.
  ...
  • A small controller then looks at that understanding and asks — by voice — for
    ...
    or commits when everything is there. This guarantees Munim always asks the
...
spoken by Munim — never invented by the model.
...
_EFFORT = os.environ.get("MUNIM_REASONING", "low")

# Dynamic language: Munim's default voice is Hindi/Hinglish, but the owner
